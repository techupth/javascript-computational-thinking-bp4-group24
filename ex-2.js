  ...
  function findUserOrder(username){
    let result;
    for (let i=0;i<orders.length;i++){
        if (username === orders[i].customerName){
            result = `Total Paid Amount of ${username}: ${orders[i].productPrice * orders[i].productQuantity} Baht`;
            break;
        } else {
  ...
  console.log(findUserOrder("Birdie Shepland"));
